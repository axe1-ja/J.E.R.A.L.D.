...
<div class="container text pt-4 p-4">  
    ...
    <div class="col-md ">
        ...
        Ekaï se réserve le droit de modifier unilatéralement et à tout moment le contenu
        des présentes CGU.
        </h4>
    </div>
    <div class="col-md ">
        ...
        <h4 class="texte ">
        L’édition et la direction de la publication du site Ekaï est assurée par 
        JERALD, domicilié au 10 rue de Vanves à Issy-les-Moulineaux.
        Adresse e-mail jeraldekai@gmail.com.
        </h4>
    </div>
    <div class="col-md ">
        <h3 class="texte "> 
        ...
        <h4 class="texte ">
        Le site Ekaï permet à l'Utilisateur un accès gratuit aux services suivants :
        ...
        la responsabilité de Ekaï. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir 
    ...
    <div class="col-md ">
        ...
        <h4 class="texte ">
        Les sources des informations diffusées sur le site Ekaï sont réputées fiables 
        ...
        Malgré des mises à jour régulières, le site Ekaï ne peut être tenu responsable 
        ...
        Le site Ekaï ne peut être tenu pour responsable d’éventuels virus qui pourraient 
    ...
    <div class="col-md ">
        ...
        liens, il sortira du site Ekaï. Ce dernier n’a pas de contrôle sur les pages web 
    ...
    <div class="col-md ">
        ...
        Ekaï. Les cookies ne contiennent pas d’information personnelle et ne peuvent 
        ...
        restent.
        L’information contenue dans les cookies est utilisée pour améliorer le site Ekaï.
