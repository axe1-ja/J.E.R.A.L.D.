...
<div class="container text-center pt-4 p-4">  
...
http://localhost:8888/public se réserve le droit de modifier unilatéralement et à tout moment le contenu
des présentes CGU.
Article 1 : Les mentions légales
L’édition et la direction de la publication du site http://localhost:8888/public est assurée par 
...
L'hébergeur du site http://localhost:8888/public est la société _______________, dont le siège social 
est situé au _______________, avec le numéro de téléphone : _______________.
ARTICLE 2 : Accès au site
Le site http://localhost:8888/public permet à l'Utilisateur un accès gratuit aux services suivants :
Le site internet propose les services suivants :
Nous proposons de regarder vos donnée recolté par la montre.
...
la responsabilité de http://localhost:8888/public. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir 
...
Les sources des informations diffusées sur le site http://localhost:8888/public sont réputées fiables 
...
Malgré des mises à jour régulières, le site http://localhost:8888/public ne peut être tenu responsable 
...
Le site http://localhost:8888/public ne peut être tenu pour responsable d’éventuels virus qui pourraient 
...
liens, il sortira du site http://localhost:8888/public. Ce dernier n’a pas de contrôle sur les pages web 
...
http://localhost:8888/public. Les cookies ne contiennent pas d’information personnelle et ne peuvent 
...
restent.
L’information contenue dans les cookies est utilisée pour améliorer le site http://localhost:8888/public.
