...
<div class="row pt-4">
    ...
    <div class="col-6 text-right">
        <form class = 'float-right' role="search" >
                <input class="form-control mr-2" name="searchDb" id="search" type="search" placeholder="Rechercher" aria-label="Search">
                <button class="btn btn-outline-primary" id="searchBtn" type="submit">Rechercher</button>
        </form>
    </div>
</div>
<div>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center ">
                ...
                <?php for ($forumpage = 2; $forumpage <= 3; $forumpage ++) { ?>
                    <li class="page-item">
                        <a class="page-link" href="/public/user/<?php echo substr($data['model'],0,5)?>_p<?php echo $forumpage?>">
                            <?php echo $forumpage; ?>
                        </a>
                    </li>
                <?php } ?>
