...
if (! empty($_POST["reset-btn"])) {
    ...
    $member = new Member();
    $displayMessage = $member->updatePassword($memberRecord[0]['id'], $_POST["password"]);
}
?>
<HTML>
<HEAD>
		...
		<div class="sign-up-container">
			<div class="">
				<form name="reset-password" action="" method="post"
					...
					<div class="signup-heading">Réinitialiser le Mot de Passe</div>
<?php
...
?>
				<div class="error-msg" id="error-msg"></div>
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Mot de Passe<span class="required error" id="forgot-password-info"></span>
							</div>
					...
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Confirmation Mot de Passe<span class="required error"
